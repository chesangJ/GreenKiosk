...
from .views import notification_upload_form,notification_list,notification_edit,notification_details
...
urlpatterns=[
    ...
    path("notification/<int:id>",notification_edit,name="notification_edit_view")
]